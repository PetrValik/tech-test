...
internal sealed class OrderProductConfiguration : IEntityTypeConfiguration<OrderProduct>
{
    ...
    public void Configure(EntityTypeBuilder<OrderProduct> entity)
    {
        ...
        entity.HasIndex(product => product.ServiceId)
        ...
        entity.Property(product => product.ServiceId)
            .IsRequired()
            .HasColumnType("binary(16)");

        entity.HasOne(product => product.Service)
            .WithMany(service => service.OrderProducts)
            .HasForeignKey(product => product.ServiceId)
